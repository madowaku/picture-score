...
export const messages: Record<string, Record<Language, string>> = {
  ...
  "PLAYで聴く": { ja: "PLAYで聴く", en: "Press PLAY" },
  "描いた絵が、ひとつの曲に。": { ja: "描いた絵が、ひとつの曲に。", en: "Your whole drawing becomes a song." },
  "音を並べて、自分だけの庭へ。": { ja: "音を並べて、自分だけの庭へ。", en: "Give your songs a place together." },
  "最初の音を描く": { ja: "最初の音を描く", en: "Draw your first sound" },
  "点のピン": { ja: "点のピン", en: "A tiny ping" },
  "横のロングトーン": { ja: "横のロングトーン", en: "A long horizontal tone" },
  "縦のコード": { ja: "縦のコード", en: "A vertical chord" },
  "なめらかな線": { ja: "なめらかな線", en: "A smooth line" },
  "跳ねる線": { ja: "跳ねる線", en: "A bouncing line" },
  "重なった線": { ja: "重なった線", en: "A rich layered line" },
  "PICTURE SCORE IS ANSWERING": { ja: "PICTURE SCORE が返事しています", en: "PICTURE SCORE IS ANSWERING" },
  "Spotlight": { ja: "ひときわ聴く", en: "Spotlight" },
  "縦に描くと、ジャーン。": { ja: "縦に描くと、ジャーン。", en: "Draw up and down: hear a chord." },
  "ぐるぐるは、どんな音？": { ja: "ぐるぐるは、どんな音？", en: "What will a spiral sound like?" },
  "名前を鳴らしてみる？": { ja: "名前を鳴らしてみる？", en: "Try drawing your name." },
  "点も、ひとつの音。": { ja: "点も、ひとつの音。", en: "Even a dot is a sound." },
  "聴いた音は、庭に少しずつ残ります。": { ja: "聴いた音は、庭に少しずつ残ります。", en: "What you hear leaves a little trace." },
  "一緒に歌った場所に、道ができました。": { ja: "一緒に歌った場所に、道ができました。", en: "A path grew where they sang together." },
  "庭の成長データを読み込めません。元データと作品はそのまま残しています。": { ja: "庭の成長データを読み込めません。元データと作品はそのまま残しています。", en: "Couldn’t read growth data. Your original data and artworks are preserved." },
  "庭の成長を保存できません。この画面では聴いた音が残ります。": { ja: "庭の成長を保存できません。この画面では聴いた音が残ります。", en: "Couldn’t save growth. Your musical traces remain on this page." },
