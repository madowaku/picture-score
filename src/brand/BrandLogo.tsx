...
export function BrandSymbol({ compact = false }: { compact?: boolean }) {
  ...
  return (
    ...
    >
      ...
      {/* p: a drawn note whose stem curls into the letter bowl. */}
      ...
      {/* s: one living stroke, ending in a sprout. */}
      <path
      ...
      />
      <path
        d="M71 19c-8-1-13-5-15-11 8-1 14 3 15 11Z"
        fill="#79a45e"
      />
      <path
        d="M72 19c1-8 6-13 13-15 1 8-4 14-13 15Z"
        fill="#5f8d51"
      />
    </svg>
  );
  ...
  return (
    <div className={`official-brand ${compact ? "compact" : ""}`}>
      ...
      <div className="official-brand-type">
        <span className="official-wordmark">picture score<span className="official-dot">.</span></span>
